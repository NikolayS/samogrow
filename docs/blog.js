  ...
  var incidents = [
    {
      ...
      story: "<p>The reading looked ordinary: 115. The cheap TDS pen was small, the reservoir routine was familiar, and nobody noticed the tiny <span class=\"code\">×10</span> indicator glowing beside the number. We mixed nutrients for 115 ppm water when the meter was actually reporting roughly 1,150 ppm.</p><p>The plants became the alarm. Mint edges browned, parsley declined, and the reservoir that had looked normal was suddenly the common suspect. A second measurement showed 128 with the multiplier still lit: 1,280 ppm. What first looked like disease or heat stress was salt burn caused by our own bad reading.</p><p>We diluted the reservoir and removed the ambiguity from the operating procedure. Every TDS report now includes the multiplier and the computed ppm, and an implausible jump is treated as a units problem before it becomes a plant problem. The cheapest instrument in the system taught us the most expensive lesson.</p>",
